...
import 'package:dashboard_call_recording/src/home.dart';
import 'package:dashboard_call_recording/widgets/side_menu.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: isMobile ? GetUserMediaSampleMobile() : GetUserMediaSample(),
    );
  }
}
